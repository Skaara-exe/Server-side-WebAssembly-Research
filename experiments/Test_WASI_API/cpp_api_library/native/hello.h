...
} hello_tuple2_field_name_field_value_t;

typedef struct {
  hello_tuple2_field_name_field_value_t *ptr;
  size_t len;
} hello_list_tuple2_field_name_field_value_t;
...
extern bool wasi_http_types_static_fields_from_list(hello_list_tuple2_field_name_field_value_t *entries, wasi_http_types_own_fields_t *ret, wasi_http_types_header_error_t *err);
// Get all of the values corresponding to a name. If the name is not present
// in this `fields` or is syntactically invalid, an empty list is returned.
// However, if the name is present but empty, this is represented by a list
// with one or more empty field-values present.
extern void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, hello_list_field_value_t *ret);
...
extern bool wasi_http_types_method_fields_set(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, hello_list_field_value_t *value, wasi_http_types_header_error_t *err);
...
extern void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, hello_list_tuple2_field_name_field_value_t *ret);
